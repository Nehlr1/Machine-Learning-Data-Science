...
Importing and modifying Data Set
...
Data_Set8['E_Plug'].quantile(0.75) - Data_Set8['E_Plug'].quantile(0.25)
...
# feature_range can be of any range

Data_Set13 = normalize(Data_Set11, norm='l2', axis=0)

# axis=0 is for mormalizing features / axis=1 is for normalising each sample
